...
public class ExtendedActiveDirectoryUserStoreManager extends ActiveDirectoryUserStoreManager {
    private static Log log = LogFactory.getLog(ExtendedActiveDirectoryUserStoreManager.class);
    ...
    public ExtendedActiveDirectoryUserStoreManager(RealmConfiguration realmConfig, Map<String, Object> properties,
        ...
        log.info("ExtendedActiveDirectoryUserStoreManager initialized...");
    }
